//! Mirage paged latent cache.
//!
//! Rust port of `src/mirage/runtime/latent_cache.py`. vLLM's PagedAttention
...
//! shape.
//!
//! The Python wrapper at `src/mirage/runtime/latent_cache.py` imports from
//! `mirage_cache._native`, this crate's library, via PyO3.
...
#[pyclass(name = "LatentPage", module = "mirage_cache._native")]
#[derive(Debug, Clone)]
...
#[pyclass(name = "CacheStats", module = "mirage_cache._native")]
...
#[pyclass(name = "PagedLatentCache", module = "mirage_cache._native")]
...
/// PyO3 module entry point. Exposed as `mirage_cache._native` in Python.
#[pymodule]
