# Mirage walkthroughs — AVID (action-conditioned video diffusion): a **design** walkthrough
...
> Mirage.** It is the deferred **Phase 3** of
...
> machinery Mirage already has* — and it doubles as the Phase-3 implementation
> plan.
...
The reason it fits Mirage cleanly: it implements the **same
...
what's reused, what it costs). Every reference to *existing* Mirage code is a real
