...
1. **The plan's own competitive analysis points here.** §5.4 Principle 3 and
   ...
   non-NVIDIA-wedge moat thesis were in tension; this resolves it.
...
An inference-cloud or AV-simulation design partner lands that is H100/H200-bound
and needs parity within the seed window — at which point the NVIDIA backend is
