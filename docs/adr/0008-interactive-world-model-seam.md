...
- **Relates to:** ADR-0001 (MI300X-first), ADR-0003 (vendor-neutral Backend
  Protocol), `docs/STRATEGIC_ASSESSMENT.md` (the moat argument this acts on)
...
`docs/STRATEGIC_ASSESSMENT.md` argues the defensible regime is the one those
...
1. **Structural differentiation.** Request/response diffusion servers will keep
   ...
   loop is a different shape they don't target. This is the moat the assessment
   names.
