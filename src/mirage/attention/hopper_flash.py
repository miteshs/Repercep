...
in :mod:`mirage.attention.registry` falls through to :class:`NaiveAttention`.

ROCm sibling: :class:`mirage.attention.rocm_flash.ROCmFlashAttention` wraps the
...
class HopperFlashAttention:
    ...
    def __call__(
        ...
        *,
        ...
        # Mirage convention is (B, H, S, D); flash_attn_func wants (B, S, H, D).
