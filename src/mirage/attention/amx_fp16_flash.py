"""Custom AMX FP16 flash-attention — the Mirage-owned Granite Rapids kernel.

Granite Rapids (GNR) sibling of :class:`mirage.attention.amx_flash.AMXFlashAttention`
...
def _detect_amx_fp16() -> bool:
    ...
    Mirrors :func:`mirage.attention.amx_flash._detect_amx_bf16` but probes
...
class AMXFP16FlashAttention:
    """Flash-attention on Intel AMX_FP16 (Granite Rapids).  Mirage-owned C++ kernel."""
