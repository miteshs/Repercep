...
SM target. Mirage's lead hardware is MI300X (ADR-0001), and the AMD path uses
...
Mirage targets. Production users training or serving at extreme aspect ratios
...
class TransformerEngineAttention:
    ...
    def __call__(
        ...
        *,
        ...
        # Mirage convention is (batch, heads, seq, head_dim) — "bhsd".  TE's
