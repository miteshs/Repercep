"""Custom AMX flash-attention — the Mirage-owned CPU kernel.

Sibling of :class:`mirage.attention.fp8_triton.FP8TritonAttention` (gfx942)
and :class:`mirage.attention.fp8_hopper_triton.FP8HopperTritonAttention`
...
class AMXFlashAttention:
    """Flash-attention on Intel AMX_BF16.  Mirage-owned C++ kernel."""
