...
if TYPE_CHECKING:
    ...
    from mirage.hardware import BackendCapabilities, DeviceSpec, DType, Vendor


@runtime_checkable
class Backend(Protocol):
    """A compute substrate Mirage can run a world model on.

    This is the single seam between Mirage and a GPU vendor.  Everything above
