"""The ``mirage`` command-line entry point."""
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    print(f"mirage: unknown command {command!r}", file=sys.stderr)
...
def _info() -> int:
    ...
    print(f"Mirage Runtime v{__version__}")
    try:
