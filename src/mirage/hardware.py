"""Core hardware domain types for Mirage.
...
(``mirage.backend``) maps these descriptions onto a concrete compute runtime.
"""
...
class DType(enum.StrEnum):
    """Numeric types Mirage reasons about for inference and kernel selection."""
...
# --- Architectures Mirage reasons about -------------------------------------
...
class BackendCapabilities:
    ...
    ``Backend.attention_op`` — but it is surfaced for diagnostics and ``mirage
    info``.
    """
