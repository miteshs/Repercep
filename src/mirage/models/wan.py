"""Wan-2.2 engine — Mirage's second world-model family.

Wan-2.2 (Alibaba's "Wan-Video" team, released 2025-07-28) is the second
diffusion-video family Mirage supports, alongside Cosmos-Predict-7B. Its job in
the Phase-2 plan is to prove Mirage's runtime is world-model-native rather than
...
This engine mirrors :class:`mirage.models.cosmos.CosmosEngine` step-for-step
...
class WanEngine:
    """Wan-2.2 T2V, served on a Mirage backend.
...
def _as_frame_tensor(video: Any) -> Any:
    ...
    Mirrors :func:`mirage.models.cosmos._as_frame_tensor`. The Wan pipeline's
